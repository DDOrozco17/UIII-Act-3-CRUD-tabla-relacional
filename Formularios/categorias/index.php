                ...
                <tbody>
                    ...
                    while ($resultado = $sql->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $resultado['categoria_producto']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['precio_unitario']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['cantidad_stock']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['provedor']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['fecha_llegada']; ?>
                            </td>
                            <td>
                                <?php echo $resultado['descripcion_productos']; ?>
                            </td>
                            <td>
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?id_producto=<?php echo $resultado['id_producto']; ?>"
                                    class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?id_producto=<?php echo $resultado['id_producto']; ?>"
